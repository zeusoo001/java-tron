...
public class BlockEventGetTest extends BlockGenerate {
    ...
    public void before() throws IOException {
        ...
        AccountCapsule accountCapsule =
            new AccountCapsule(Protocol.Account.newBuilder().setAddress(addressBS).setBalance((long) 1e10).build());
    ...
    public void test() throws Exception {
        ...
        ChainBaseManager.getChainBaseManager().getWitnessScheduleStore().saveActiveWitnesses(new ArrayList<>());
        ChainBaseManager.getChainBaseManager().addWitness(ByteString.copyFrom(address));


        String code = "608060405234801561000f575f80fd5b50d3801561001b575f80fd5b50d28015610027575f80fd5b503373" +
            "ffffffffffffffffffffffffffffffffffffffff165f73ffffffffffffffffffffffffffffffffffffffff167fddf252" +
            "ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef6402540be40060405161008a91906100e2565b" +
            "60405180910390a36100fb565b5f819050919050565b5f819050919050565b5f819050919050565b5f6100cc6100c761" +
            "00c284610097565b6100a9565b6100a0565b9050919050565b6100dc816100b2565b82525050565b5f60208201905061" +
            "00f55f8301846100d3565b92915050565b603e806101075f395ff3fe60806040525f80fdfea26474726f6e582212200c" +
