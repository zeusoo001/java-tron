...
public class BlockEventLoadTest {
  ...
  public void test() throws Exception {
    ...
    BlockCapsule c1 = new BlockCapsule(1L, b0, 0L,
    ...
    BlockCapsule c2 = new BlockCapsule(2L, b1, 0L,
        ByteString.copyFrom(BlockEventCacheTest.getBlockId()));
    be2.setBlockId(b2);
    be2.setParentId(b1);
    ...
    BlockCapsule c22 = new BlockCapsule(2L, b1, 0L,
        ByteString.copyFrom(BlockEventCacheTest.getBlockId()));
    be22.setBlockId(b22);
    be22.setParentId(b1);
    ...
    BlockCapsule c3 = new BlockCapsule(3L, b2, 0L,
        ByteString.copyFrom(BlockEventCacheTest.getBlockId()));
    be3.setBlockId(b3);
    be3.setParentId(b2);
    ...
    BlockCapsule c23 = new BlockCapsule(3L, b22, 0L,
        ByteString.copyFrom(BlockEventCacheTest.getBlockId()));
    be23.setBlockId(b23);
