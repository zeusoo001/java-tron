...
public class HistoryEventServiceTest {
  ...
  public void test() throws Exception {
    ...
    Mockito.when(blockEventLoad.getBlockEvent(1)).thenReturn(be1);
    ...
    Method method1 = historyEventService.getClass().getDeclaredMethod("syncEvent", Long.class);
    method1.setAccessible(true);
    method1.invoke(historyEventService, 1l);
