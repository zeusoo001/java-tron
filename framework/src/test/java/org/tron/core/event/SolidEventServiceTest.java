...
public class SolidEventServiceTest {
  ...
  public void test() throws Exception {
    ...
    ReflectUtils.setFieldValue(solidEventService, "transactionLogTriggerEnable", true);
    ReflectUtils.setFieldValue(solidEventService, "transactionLogTriggerSolidified", true);
    solidEventService.flush(be2);
    Assert.assertEquals(1, queue.size());
    ...
    ReflectUtils.setFieldValue(solidEventService, "solidityLogTriggerEnable", true);
    try {
      solidEventService.flush(be2);
    } catch (Exception e) {
    ...
    ReflectUtils.setFieldValue(solidEventService, "solidityEventTriggerEnable", true);
    ...
    ReflectUtils.setFieldValue(solidEventService, "solidityTriggerEnable", true);
